...
| 2026-09-16 | shadcn-ui 개정 (Base UI 기본 확정, 링크는 buttonVariants, 디자인 토큰·data-slot 절, 툴링 절, Sidebar 보강) + references/shadcn-setup.md 신설·radix-migration.md 갱신 | nextjs-kit | shadcn/ui·Base UI 공식 문서 베스트 프랙티스 반영 |
